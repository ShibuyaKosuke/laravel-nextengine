...
class ReceiveOrderBaseTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->receiveOrderBase = new ReceiveOrderBase(
            ...
            'receive_order_purchaser_name' => '野口 栄晴',
            'receive_order_purchaser_kana' => '野口栄晴',
            'receive_order_purchaser_zip_code' => '1010052',
            'receive_order_purchaser_address1' => '神田小川町3-28-9',
            'receive_order_purchaser_address2' => '8F',
            'receive_order_purchaser_tel' => '0352807025',
            'receive_order_purchaser_fax' => null,
            'receive_order_purchaser_mail_address' => null,
            'receive_order_consignee_name' => '野口 栄晴',
            'receive_order_consignee_kana' => 'ノグチグチヨシハル',
            'receive_order_consignee_zip_code' => '1010052',
            'receive_order_consignee_address1' => '神田小川町3-28-9',
            'receive_order_consignee_address2' => '三東ビル8F',
            'receive_order_consignee_tel' => '0352807025',
            ...
            'receive_order_creator_name' => '野口 栄晴',
            'receive_order_last_modified_by_id' => '2',
            'receive_order_last_modified_by_null_safe_id' => '2',
            'receive_order_last_modified_by_name' => '野口 栄晴',
            'receive_order_last_modified_by_null_safe_name' => '野口 栄晴',
            ]
        );
        $this->receiveOrderOption = new ReceiveOrderOption(
            ...
            'receive_order_option_creator_name' => '野口 栄晴',
            'receive_order_option_last_modified_by_id' => '2',
            'receive_order_option_last_modified_by_null_safe_id' => '2',
            'receive_order_option_last_modified_by_name' => '野口 栄晴',
            'receive_order_option_last_modified_by_null_safe_name' => '野口 栄晴',
            ]
        );
        $this->receiveOrderRows[] = new ReceiveOrderRow(
            ...
            'receive_order_row_creator_name' => '野口 栄晴',
            'receive_order_row_last_modified_by_id' => '2',
            'receive_order_row_last_modified_by_null_safe_id' => '2',
            'receive_order_row_last_modified_by_name' => '野口 栄晴',
            'receive_order_row_last_modified_by_null_safe_name' => '野口 栄晴',
            ]
        );
        $this->receiveOrderRows[] = new ReceiveOrderRow(
            [
